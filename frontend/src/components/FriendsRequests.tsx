...
const FriendsRequests = () => {
  ...
  return (
    <section className="friend-section">
      {loading && (
        <p className="friend-state-text">Loading friend requests...</p>
      )}
      {!loading && errorMessage && (
        <p className="friend-state-text error">
              ...
              <li className="friend-list-item" key={request._id}>
                ...
                <div className="friend-list-actions">
                  <button
                    ...
                    type="button"
                    onClick={() => handleAccept(request.senderUsername)}
                  >
                    accept
                  </button>
                  <button
                    ...
                    type="button"
                    onClick={() => handleReject(request.senderUsername)}
                  >
                    reject
                  </button>
                </div>
